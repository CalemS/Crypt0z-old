...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Crypt0z " + FormatFullVersion();
...
{www.crypr0z.com, 18.188.133.48:rpc}
{NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    0x0f1ada12, 0x3238da12, 0x3085bc12
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Crypt0z is probably already running."), addrBind.ToString().c_str());
        else
